			...
			<header id="header">
				<nav id="nav">
					<ul>
						...
						<li><a href="table.php?table=technical_mean">Технические средства</a></li>
						<li><a href="table.php?table=workstation">Автоматизированные рабочие места</a></li>
						<li><a href="table.php?table=responsible_for_commissioning">Материальная ответственность</a></li>
...
<section id="main" class="wrapper">
				<div class="container">
							...
							<p><span class="image left"><img src="images/profile_placeholder4.gif" alt="" /><?php echo ($_SESSION['login']);?></span>
														<section>
