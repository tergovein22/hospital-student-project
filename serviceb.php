			...
			<header id="header">
				<nav id="nav">
					<ul>
						...
						<li><a href="table.php?table=plan_maintenance">Техническое обслуживание</a></li>
...
<section id="main" class="wrapper">
				<div class="container">
							...
							<p><span class="image left"><img src="images/profile_placeholder2.gif" alt="" /><?php echo ($_SESSION['login']);?></span>
														<section>
